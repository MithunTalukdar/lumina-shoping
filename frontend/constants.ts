...
const womenClothingSeed: CatalogSeed[] = [
  {
...
const menShoesSeed: CatalogSeed[] = [
  {
...
const womenShoesSeed: CatalogSeed[] = [
  {
...
const getSectionProducts = (gender: Product["gender"], type: Product["type"]) =>
  STORE_PRODUCTS.filter((product) => product.gender === gender && product.type === type);

export const MEN_COLLECTION = getSectionProducts("men", "clothing");
export const WOMEN_COLLECTION = getSectionProducts("women", "clothing");
export const MEN_SHOES = getSectionProducts("men", "shoes");
export const WOMEN_SHOES = getSectionProducts("women", "shoes");
export const INITIAL_PRODUCTS = STORE_PRODUCTS;
